...
if HAS_SSL:
    URL = "https://autonomous-kaylil-nitish07-ee7a7ac0.koyeb.app/".format(FQDN)
else:
    URL = "https://autonomous-kaylil-nitish07-ee7a7ac0.koyeb.app/".format(FQDN, "" if NO_PORT else ":" + str(PORT))
