...
BOT_USERNAME = environ.get("BOT_USERNAME", 'KR_file_to_linkbot') # without @ 

# Admins, Channels & Users
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002307229605')) # admin your channel in stream 
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002461306484')) # admin your channel in users log 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7045947967').split()] # 3567788, 678899, 5889467
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'Searching7_filebot') # without @ 

# pics information
PICS = environ.get('PICS', 'https://envs.sh/_pM.jpg')

# channel link information
CHANNEL = environ.get('CHANNEL', 'https://t.me/movie_bazaar07')
SUPPORT = environ.get('SUPPORT', 'https://t.me/moviesbazaarsupp')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://keshavrajlkr8:5XQbQFRIn89xQRi4@cluster0.e8tfylk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
#Dont Remove My Credit @AV_BOTz_UPDATE 
#This Repo Is By @BOT_OWNER26 
# For Any Kind Of Error Ask Us In Support Group @moviesbazaarsupp
...
if HAS_SSL:
    URL = "https://developed-francesca-keshavrajlkr2-74dfdbee.koyeb.app/".format(FQDN)
else:
    URL = "https://developed-francesca-keshavrajlkr2-74dfdbee.koyeb.app/".format(FQDN, "" if NO_PORT else ":" + str(PORT))
