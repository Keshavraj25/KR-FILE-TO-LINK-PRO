...
if HAS_SSL:
    URL = "https://continued-hyacinthie-nitish7-79cc145a.koyeb.app/".format(FQDN)
else:
    URL = "https://continued-hyacinthie-nitish7-79cc145a.koyeb.app/".format(FQDN, "" if NO_PORT else ":" + str(PORT))
